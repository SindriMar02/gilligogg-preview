...
const ROOT = '/Users/sindri/Documents/Website redesign mockups/gilligogg-bar';
const PORT = parseInt(process.env.PORT || '5931', 10);
...
}).listen(PORT, '127.0.0.1', () => console.log('gilligogg static server on http://127.0.0.1:' + PORT));
