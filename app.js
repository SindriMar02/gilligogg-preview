/* ═══════════════════════════════════════════════════════════
   GILLIGOGG — Austurstræti 12A, Reykjavík.
...
/* ═══════════ THE HERO PLATE ══════════════════════════════
   The source build scrubbed a generated film here. Gilligogg
   gets its own photograph instead, and that is a deliberate
   deviation rather than a shortcut: their room is a specific,
   recognisable place — Kjarval's old studio building, hung
   with four paintings by a named living artist — so a
   generated interior would be a fabricated picture of a real
   business's premises. The scroll still drives the same
   `--film-s` push-in through the same pinned timeline; only
   the thing being pushed changed.
   ═══════════════════════════════════════════════════════════ */
